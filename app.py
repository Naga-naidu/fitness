from flask import Flask,request,render_template,url_for,redirect,flash,session,abort
...
mydb = mysql.connector.connect(host='localhost',user='root',password='admin',db='fitness')
